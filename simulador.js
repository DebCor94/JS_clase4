...
function seleccionarTicket () {
        let ticket = prompt("Elige tu tipo de pase: bronce, plata u oro", "Oro").toUpperCase();
        let invitados = parseInt(prompt("Selecciona la cantidad de tickets que deseas"));
        let precio = 0;
...
function agregarCupon () {
    cuponDescuento = prompt("¿Querés agregar un cupón de descuento?", "Si").toUpperCase();
